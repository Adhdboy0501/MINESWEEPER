...
with open ('text.txt','w+') as f:
    ...
    f.write(a)
def f1():
    os.system("src\\code\\level-final.py")
def f2():
    os.system("src\\code\\sign_in.py")


bg = PhotoImage(file = "src\\assets\\title.png")
label1 = Label( root, image = bg)
label1.place(x = 0,y = 0)



photo=Image.open("src\\assets\\sign.png")
...
photo1=Image.open("src\\assets\\play.png")
...
photo2=Image.open("src\\assets\\how.png")
